                        ...
                        <td class="px-6 py-4 whitespace-no-wrap">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-xs leading-5 text-gray-500">
                                    {{$four->type}} - {{$four->typeOrganisation}}
                                </div>
                            </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-no-wrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full @if($four->statut == 'DFCG') bg-green-100 text-green-800 @elseif($four->statut == 'DEMANDEUR')  bg-red-100 text-red-800 @elseif($four->statut == 'comptalbe') bg-orange-100 text-orange-800 @else bg-gray-100 text-gray-800 @endif">
                            {{ $four->statut  }} 
                            </span>
                        </td>
