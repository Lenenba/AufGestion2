        <div class=" flex-1 flex justify-between items-center bg-white shadow-md mx-4 text-sm text-gray-400 border-l-4 border-{{$color}}-700 rounded-lg hover:bg-{{$color}}-100 ">
              ...
              <vue-ellipse-progress :progress="{{ ($elts*100)/10000 }}" :size="150" class="mr-10 my-2 flex justify-items-center text-xs text-{{$color}}-700 "  color="{{$color}}">
                <p slot="legend-caption">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-{{$color}}-700 flex rounded-lg text-xs w-20">
